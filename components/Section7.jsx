const Section7 = () => {
  return (
    <>
      <div className="faq-container border-t border-neutral-200 py-20 sm:py-32">
        <div className="inner-faq mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="faq-heading mx-auto max-w-2xl lg:mx-0">
            <h2 className="font-medium text-[32px] tracking-tight text-neutral-900">
              Frequently asked questions
            </h2>
            <p className="mt-2 text-lg text-neutral-600">
              If you have anything else you want to ask,
              <a className="text-neutral-900 underline" href="#">
                {" "}
                reach out to us
              </a>
            </p>
